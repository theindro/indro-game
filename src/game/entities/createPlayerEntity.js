...
export function createPlayerEntity(world) {
    ...
    pShadow.ellipse(0, 18, 12, 4).fill({ color: 0x000000, alpha: 0.25 });
    ...
    pCont.addChild(leftEye);

    const rightEye = new Graphics();
    rightEye.circle(6, -3.5, 3.5).fill(0x112233);
    rightEye.circle(5, -4.5, 1).fill(0xffffff);
    pCont.addChild(rightEye);

    // 🔴 HP BAR
    const hpBg = new Graphics();
    hpBg.rect(-20, -32, 40, 6).fill({ color: 0x000000, alpha: 0.4 });
    pCont.addChild(hpBg);
