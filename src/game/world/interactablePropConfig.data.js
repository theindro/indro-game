...
export const LOOT_TABLES = {
    ...
    grove_boss_chest: [
        ...
        { id: 'iron_boots',      chance: 0.62, min: 1, max: 1 },
        { id: 'iron_gloves',     chance: 0.6, min: 1, max: 1 },
        { id: 'shadow_armor',    chance: 0.55, min: 1, max: 1 },
        { id: 'shadow_helmet',   chance: 0.52, min: 1, max: 1 },
        { id: 'iron_bow',        chance: 0.58, min: 1, max: 1 },
        { id: 'iron_ring',       chance: 0.65, min: 1, max: 1 },
        { id: 'shadow_ring',     chance: 0.55, min: 1, max: 1 },
        { id: 'ancient_amulet',  chance: 0.42, min: 1, max: 1 },
    ],
